...
\end{figure}
 ...
 \item \textbf{Összevonó réteg (Pooling layer)} -

 \item \textbf{Rekurrens réteg (Recurrent layer)} - 
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth, height=7cm]{vae.png}
...
\end{figure}
 ...
 \item \textbf{Rekurrens Neurális Háló (RNN)} - 
