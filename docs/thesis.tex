...
\usepackage{tikz}
\usepackage{xcolor}
\usepackage{pgfplots}\usepackage[final]{pdfpages}

\definecolor{bblue}{HTML}{4F81BD}
\definecolor{rred}{HTML}{C0504D}
\definecolor{oorange}{HTML}{ffb366}
\definecolor{bbrown}{HTML}{805500}
...
\department{Inormációs Rendszerek Tanszék} % tanszék neve / department's name
...
\maketitle
\includepdf[pages=-,width=\textwidth+2cm]{topicdesc.pdf}
